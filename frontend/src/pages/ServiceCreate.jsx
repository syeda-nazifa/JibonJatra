...
export default function ServiceCreate({ token }) {
  ...
  const validateForm = () => {
    ...
    if (!form.servicePicture) newErrors.servicePicture = "Service image is required";
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              {errors.servicePicture && <p className="mt-1 text-sm text-red-600">{errors.servicePicture}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Cleaning, Repair, Consultation, Delivery"
              />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe your service in detail. What does it include? How long does it take? Any special requirements?"
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="Where is this service available? (City, Area, etc.)"
              />
