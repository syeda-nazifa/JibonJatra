...
// // Get feed with all content types
...
//       case 'posts':
//         content = await Post.find()
//           .populate('user', 'username profilePicture') // Uses 'user'
//           .sort({ createdAt: -1 })
//           .skip(skip)
//           .limit(limit)
//           .lean();
...
//       case 'market':
//         content = await Market.find()
//           .populate('createdBy', 'username profilePicture') // Uses 'createdBy'
//           .sort({ createdAt: -1 })
//           .skip(skip)
//           .limit(limit)
//           .lean();
...
//       case 'products':
//         content = await Product.find()
//           .populate('owner', 'username profilePicture') // Uses 'owner'
//           .sort({ createdAt: -1 })
//           .skip(skip)
//           .limit(limit)
//           .lean();
...
//     // Get announcements for sidebar - uses 'createdBy'
//     const announcements = await Announcement.find()
//       .populate('createdBy', 'username')
//       .sort({ createdAt: -1 })
//       .limit(5)
